        ...
        <div className="container">
         ...
         <div className="row">
            <div className="col-md-6 d-flex mt-2">
                ...
                <i class="fa-brands fa-paypal mt-3 mx-2 fa-xl"></i>
                <i class="fa-brands fa-cc-mastercard  mt-3 mx-2 fa-xl"></i>
                <i class="fa-brands fa-cc-visa mt-3 mx-2 fa-xl"></i>
            </div>
         ...
         <div className="row">
            <div className="col-md-12 d-flex justify-content-center">
                <p className='fw-bold my-auto' >Crtead By <span style={{color:'#0aad0a'}}>Flashcards@.com</span></p>
            </div>
         </div>
        </div>
